...
// 1xs:text-5xl 1xs:ml-20 1xs:mt-10 sm:text-7xl sm:mt-8 sm:ml-8 md:ml-[5rem] lg:ml-[14rem] xl:text-9xl xl:ml-[22rem] 2xl:text-9xl 3xl:text-9xl 3xl:ml-[6rem]
// 1xs:mt-8 1xs:p-4 1xs:text-lg sm:w-[70%] sm:ml-16 sm:mt-14 sm:text-xl 2xl:w-[50%] 3xl:w-[40%] 3xl:text-xl 3xl:ml-[26rem] 3xl:mt-[8rem]
// 1xs:p-4 1xs:text-lg sm:w-[70%] sm:ml-16 sm:mt-14 sm:text-xl lg:ml-[14rem] 2xl:w-[50%] 3xl:w-[40%] 3xl:text-xl 3xl:mt-[8rem] 3xl:ml-[40rem]
// 1xs:text-5xl 1xs:ml-20 1xs:mt-10 sm:text-7xl sm:mt-8 sm:ml-8 md:ml-[5rem] lg:ml-[18rem] 2xl:text-9xl 2xl:ml-18 3xl:text-[10rem] 3xl:ml-[12rem]
